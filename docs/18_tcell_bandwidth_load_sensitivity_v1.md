...
|---|---:|---:|---:|---:|
| A | 60.69 dB | 理想匹配 | 60.69 dB | 21.498% → 21.511% |
| B | 55.75 dB | 理想匹配 | 55.75 dB | 30.167% → 30.179% |
| C | 40.18 dB | 理想匹配 | 40.18 dB | 47.584% → 47.587% |
...
|---|---:|---:|
| A | 32.64 dB | 18.31%–25.08% |
| B | 29.78 dB | 26.11%–34.55% |
| C | 25.98 dB | 42.62%–52.60% |
...
| Board | cell worst input RL | extraction range |
|---|---:|---:|
| A | 25.85 dB | 15.44%–29.12% |
| B | 23.08 dB | 22.36%–39.32% |
| C | 19.47 dB | 37.70%–57.66% |
...
| Board | cell worst input RL | extraction range |
|---|---:|---:|
| A | 20.87 dB | 12.45%–34.52% |
| B | 18.24 dB | 18.33%–45.40% |
| C | 14.88 dB | 32.05%–63.60% |
...
> 本节数值已按 `docs/19_tcell_exact_equal_power_synthesis_v1.md` 的 loss-corrected κ = 0.214983 / 0.301666 / 0.475842 重新计算；不再使用早期 6.5/5/3 dB 近似值。
