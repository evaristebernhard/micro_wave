...
export const matchedExtractionTCellSeed = {
  referenceOhm: 50,
  assumedCellLossDb: 0.42,
  cellPowerTransmission: 0.907821,
  equalPatchPowerFractionOfInput: 0.214983,
  ...
  variants: {
    A: {
      k: 0.214983,
      couplingDb: 6.676,
      seriesTransformerOhm: 44.301,
      seriesTransformerWidthMm: 3.810,
      seriesQuarterWaveMm: 16.785,
      branchTransformerOhm: 95.545,
      branchTransformerWidthMm: 0.819,
      branchQuarterWaveMm: 17.664,
      junctionX: -5.469,
      junctionY: -26.046,
      onboardThroughTailMm: 26.900,
      requiredIntercellEquivalent50OhmMm: 6.943,
      requiredIntercellPhaseDeg: 36.93,
      intercellEffectivePermittivityFor9p6mm: 1.709
    },
    B: {
      k: 0.301666,
      couplingDb: 5.205,
      seriesTransformerOhm: 41.783,
      seriesTransformerWidthMm: 4.169,
      seriesQuarterWaveMm: 16.721,
      branchTransformerOhm: 76.074,
      branchTransformerWidthMm: 1.415,
      branchQuarterWaveMm: 17.422,
      junctionX: -5.414,
      junctionY: -25.809,
      onboardThroughTailMm: 26.778,
      requiredIntercellEquivalent50OhmMm: 7.064,
      requiredIntercellPhaseDeg: 37.57,
      intercellEffectivePermittivityFor9p6mm: 1.770
    },
    C: {
      k: 0.475842,
      couplingDb: 3.225,
      seriesTransformerOhm: 36.199,
      seriesTransformerWidthMm: 5.153,
      seriesQuarterWaveMm: 16.568,
      branchTransformerOhm: 52.477,
      branchTransformerWidthMm: 2.892,
      branchQuarterWaveMm: 16.977,
      junctionX: -5.356,
      junctionY: -25.360,
      onboardThroughTailMm: 26.595,
      requiredIntercellEquivalent50OhmMm: 7.248,
      requiredIntercellPhaseDeg: 38.55,
      intercellEffectivePermittivityFor9p6mm: 1.863
    }
  },
  commonIntercellPhaseSeedDeg: 37.7,
  ...
  complexPatchExcitationSeed: {
    amplitude: 0.463663,
    phaseDeg: { A: 0, B: 90, C: 180, D: 270 },
    complex: {
      A: [0.463663, 0.0],
      B: [0.0, 0.463663],
      C: [-0.463663, 0.0],
  ...
  primaryAdvantage: "exact-loss-corrected-equal-power-with-ordinary-line-widths",
