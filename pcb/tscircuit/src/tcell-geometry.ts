...
const intercellResidual = (boardClass: "A" | "B" | "C") =>
  matchedExtractionTCellSeed.variants[boardClass].requiredIntercellPhaseDeg -
  matchedExtractionTCellSeed.commonIntercellPhaseSeedDeg
...
export const tCellVariantMeta = {
  A: {
    ...
    bridgeResidualPhaseDeg: intercellResidual("A"),
    hasRfOut: true
  },
  B: {
    boardClass: "B",
    ...
    bridgeResidualPhaseDeg: intercellResidual("B"),
    hasRfOut: true
  },
  C: {
    boardClass: "C",
    ...
    bridgeResidualPhaseDeg: intercellResidual("C"),
    hasRfOut: true
  },
  D: {
    boardClass: "D",
